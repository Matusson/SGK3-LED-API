...
namespace SGK3
{
    public static class KeyManager
    {
        ...
        private readonly static List<byte[]> _keyCodes = new()
        {
            // These are ordered by top from bottom, from left to right
        ...
        public static Task SetKeyColor(Key keyId, Color color)
        {
            ...
            data.Add(_keyCodes[(int)keyId][0]);
            data.Add(_keyCodes[(int)keyId][1]);

            data.AddRange(new byte[] { 0x11, 0x03 });
            data.Add(_keyCodes[(int)keyId][2]);
            data.Add(_keyCodes[(int)keyId][3]);
